<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GCTickets_Web.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="Img/t.gif" alt="" />
                    <div class="intro-text">
                        <span class="name">GC Tickets</span>
                        <hr class="star-light" />
                        <span class="skills">GC Tickets Web - Tickets Sales - 10/10 Experience Sales</span>
                    </div>
                </div>
            </div>
        </div>
