<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VentasCForm.aspx.cs" Inherits="GCTickets_Web.Consultas.VentasCForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="text-center">
            <div class="col-md-12">
                <h1 class="page-header">Consulta Ventas </h1>
            </div>
        </div>
    </div>
            ...
            <asp:GridView ID="ConsultaGridView" runat="server" class="table table-bordered table-hover table-striped table-responsive" AutoGenerateColumns="true">
                <Columns>
                    <asp:HyperLinkField
                        ...
                        DataNavigateUrlFormatString="/Registros/VentasForm.aspx?ID={0}"
                        Text="Editar" />
                </Columns>
            </asp:GridView>
        </div>
